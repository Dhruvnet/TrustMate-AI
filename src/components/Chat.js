    ...
    return (
        <div class="flex">
            ...
            <div class="md:w-5/12 lg:inline md:inline hidden h-screen border-r-2 border-r-gray-700">
                <div className='m-5 flex flex-row gap-1 justify-center'>
                    <div className='justiy-center align-center'>
                        <img src={logo} alt="TrustMate" className='w-60 object-contain' />
                    </div>
                ...
                <div className='flex flex-col justify-center mx-5'>
                    ...
                    <button type="button" className='text-gray-900 hover:text-white border border-gray-800 hover:bg-gray-900 focus:ring-4 focus:outline-none focus:ring-gray-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center me-2 mb-2 dark:border-gray-600 dark:text-gray-400 dark:hover:text-white dark:hover:bg-gray-600 dark:focus:ring-gray-800'>Who is Dhruvnet?</button>
                ...
                <div className='flex flex-col lg:pt-16 mb-16  gap-1 w-full'>
                    <div className="chats m-5 bg-blue-950 border-2 border-blue-700 rounded-sm">
                        ...
                        <div className="chat bg-blue-950 flex flex-row gap-2 p-5">
                            ...
                            <p className='w-fit bg-transparent'>Hey! I'm your TrustMate. How can I assist you?</p>
                        </div>
                    </div>
